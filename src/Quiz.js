    ...
    try {
      const openaiResponse = await fetch('https://api.openai.com/v1/completions', {
        ...
        body: JSON.stringify({
          ...
          prompt: "Create 5 items test : + " + inputText,
          temperature: 0,
          max_tokens: 200,
          top_p: 1.0,
  ...
  return (
    <>
      ...
      <div className="mt-5 container text">
        <h1><span className='quizify'>Quizify</span> - Quiz Maker </h1>
      </div>
            ...
            <Row className='mt-3'>
              <Col xs={6}>
                <Form.Group>
                  ...
                  <button className="btn btn-dark nav-button" onClick={handlePdfSubmit}>Extract Text</button>
                </Form.Group>
              </Col>
